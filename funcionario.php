<?php 
    ...
    $turma=new funcionarioController();
    $disc=$turma->getFuncionario();
...
<html>
    ...
    <body>
        ...
        <div class=" container mt-5">
            <h2 class="text-secondary text-center">Gestão dos funcionarios</h2>
            ...
            <tbody id="recebe">
                ...
                foreach ($disc as $d){?>
                   ...
                   <td> <?= $d['user']?></td> 
                       ...
                       <td> <?= $d['tipo']?></td> 
                       <td> <?= $d['status']?></td> 
                   <td><a class="btn btn-sm btn-danger text-light" data-toggle="modal"   data-target="#apagar" data-whatever1="<?= $d['id']?>" >apagar</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="controller/funcionarioController.php" method="post" class="p-2">
              <div class="row">
              ...
              <div class="row">
                  ...
                  <div class="form-group pl-1 col-6">
                      ...
                      <select id="quantidadec" class="form-control form-control-sm">
              ...
              <div class="row">
                  <div class="form-group pl-1 col-12">
                      ...
                      <select id="precoTotalc" class="form-control form-control-sm">
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h5 class="modal-title text-light" id="exampleModalLabel">Acualizacao dos dados do funcionario</h5>
      ...
      <div class="modal-body">
          <form action="controller/funcionarioController.php" method="post">
              ...
              <div class="row">
                  ...
                  <div class="form-group pl-1 col-6">
                      <label>Tipo</label>
                      <select id="quantidade" class="form-control form-control-sm">
                        <option value="Cliente">Cliente</option>
                          <option value="Normal">Normal</option>
                          <option value="Admin">Administrador</option>
                      </select>
              ...
              <div class="row">
                  <div class="form-group pl-1 col-12">
                      ...
                      <select id="precoTotal" class="form-control form-control-sm" required>
                        <option value="Activo">Activo</option>
...
<script type="text/javascript">
    ...
    $('#but_salvar').click(function(e){
       ...
       // Pega os valores dos inputs e coloca nas variáveis
        ...
        $.post('controller/funcionarioController.php', {  
            stockId:stockId,
...
$(document).ready(function(){
    $('#update').on('show.bs.modal', function (event) {
                ...
                var recipient7 = button.data('whatever7'); // Extract info from data-* attributes
                ...
                modal.find('#codigo').val(recipient7);
