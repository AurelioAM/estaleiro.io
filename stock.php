...
<html>
    ...
    <body>
        ...
        <div class=" container mt-5">
            <h2 class="text-secondary text-center">Gestão do stock</h2>
                ...
                foreach ($disc as $d){?>
                   ...
                   <td class="text-center">
                       <a class="btn btn-sm btn-primary text-light" data-toggle="modal" data-target="#update" data-whatever1="<?= $d['id']?>" 
                          data-whatever2="<?= $d['id_produto']?>" data-whatever3="<?= $d['preco']?>"  data-whatever4="<?= $d['quantidade']?>" >Update</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h5 class="modal-title text-light" id="exampleModalLabel">Gestao do stock</h5>
          ...
          <form action="controller/vendaController.php" method="post" class="p-2">
              <div class="row">
                  <div class="form-group pl-1 col-4">
                      ...
                      <select id="stockIdc" class="form-control form-control-sm">
                          <?php
                          foreach ($prod as $pro){?>
...
<script type="text/javascript">
    ...
    $('#but_salvar').click(function(e){
       ...
       // Pega os valores dos inputs e coloca nas variáveis
        ...
        $.post('controller/stockController.php', {  
            stockId:stockId,
